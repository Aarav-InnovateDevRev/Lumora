...
<div style={{
  ...
  right: 0,
  bottom: 0,
  backgroundImage: 'ur[](https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=1920&q=80)',
...
{/* Soft cream overlay (lighter so forest is visible) */}
<div style={{
  position: 'fixed',
  top: 0,
  left: 0,
  right: 0,
  bottom: 0,
  backgroundColor: 'rgba(248, 241, 233, 0.72)',
  zIndex: 1,
}} /> 
